...
public class NotaController {
    ...
    public ResponseEntity<List<Nota>> buscarNotasDaDisciplina(@PathVariable Long id) {
    ...
    public ResponseEntity<List<Nota>> buscarNotasDoAlunoEmUmaDisciplina(@PathVariable String cpf, @PathVariable Long id) {
